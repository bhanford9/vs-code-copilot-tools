...
Before starting, read `~/Repos/copilot-configs/skills/temp-debug-logging/LessonsLearned.GLOBAL.md` and, if it exists on disk, `~/Repos/copilot-configs/skills/temp-debug-logging/LessonsLearned.md`. Apply any recorded patterns to this session.
...
Both files are at `~/Repos/copilot-configs/skills/temp-debug-logging/`.
