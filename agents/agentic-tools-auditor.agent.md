...
Read `~\.copilot\skills\agentic-tools-auditor\SKILL.md` before starting. It contains the full audit framework, dimension definitions, and output formats you will use.

Also read `~\.copilot\skills\agentic-tools-auditor\LessonsLearned.md` now if it exists. Apply any recorded lessons to improve this run.
...
6. **Framework reference**: the absolute path to `~\.copilot\skills\agentic-tools-auditor\SKILL.md` for audit dimensions and output format
...
Produce the synthesis report at `{WORKSPACE_ROOT}/AUDIT-SYNTHESIS.md`. Follow the synthesis report format defined in `~\.copilot\skills\agentic-tools-auditor\SKILL.md` exactly.
...
This phase closes the feedback loop. Read `~/.copilot/skills/lessons-learned/SKILL.md` and follow the feedback loop process. The LessonsLearned file for this skill is `~\.copilot\skills\agentic-tools-auditor\LessonsLearned.md`.
