...
When reading code, go beyond describing *what* it does—extract *why* it exists and what business/engineering goal it serves.
...
> ⚠️ **Note**: This documentation was generated from code analysis only. No design documentation was found in `Material-Selection/`.
...
2. **{DecisionName}** ⇒ {what it decides}
   - Yes → {outcome} — *because {rationale}*
   - No → {outcome} — *because {rationale}*
